      ...
      <div class="container-fluid">
		...
		<?php
			...
			foreach($newdocs as $doc) { ?>
				...
				<a href="datawrites/deleteDocument.php?documentID=<?php echo $doc['documentID']?>"><button>Delete</button></a>
				<br>
				<br>				
		...
		<?php
			...
			foreach($docs as $doc) { ?>
				<a href="pdf/<?php echo $doc['name']; ?>" target="_blank" />
				<!--?php echo var_dump($doc); ?-->
				<?php echo $doc['sitename'].": ". $doc['title']; ?> </a>
				<button onclick="myFunction(<?php echo $doc['documentID']; ?>)">Edit Sites</button>
				<br>
				<div style="display:none" id="sitediv<?php echo $doc['documentID']; ?>">
					...
					<form method="post" action="datawrites/updatedocsite.php" >
						<input type="hidden" id="docId" name="docid" value="<?php echo $doc['documentID']; ?>">
						<select class="custom-select" name="site">
								<option value="<?php echo $doc['buildingsiteID']; ?> selected"> <?php echo $doc['sitename']; ?></option>
								<?php 
								foreach ($sites as $site) { ?>
									<option value="<?php echo $site['buildingsiteID']; ?>"> <?php echo $site['sitename']; ?></option>
								<?php } ?>
			...
			<?php foreach($docs as $doc) {?>
				<tr>
				<th scope="row"><a href="pdf/<?php echo $doc['name'];?>" target="_blank"><?php echo $doc['title'];?></a></th>
				<th></th>
				<th></th>
				<th><a href="datawrites/deleteDocument.php?documentID=<?php echo $doc['documentID']?>"><span class="material-icons">delete</a></span></th>
				</tr>
			<?php } ?>
			</tbody>
			</table>
